...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	int model1 = MV1LoadModel("“§‰ß–³‘o\\“§‰ß–³‘o\\tkms_Blender.mv1");
	int model2 = MV1LoadModel("“§‰ß–³‘o\\“§‰ß–³‘o\\tkms_Blender.mv1");
	...
	while (ScreenFlip() == 0 && ProcessMessage() == 0 && ClearDrawScreen() == 0 && !MouseData::GetClick(2))
	{
		...
		if (model1Flag)
		{
			...
			DrawCapsule3D(model1VecUp, model1VecDown, 50.0f, 8, GetColor(0, 255, 0), GetColor(255, 255, 255), false);		// “–‚½‚è”»’è‚ðŠm”F—p‚Ì•\Ž¦ƒeƒXƒg
		}
